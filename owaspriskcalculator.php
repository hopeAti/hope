...
<html lang="en">
	<head>
			...
			<link rel="stylesheet" type="text/css" href="/owasp_risk.css">
			<script type="text/javascript" src="/owasp_script.js"></script>
	</head>
	<body>
		
		
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="index.html"><img src="images//logo.png" alt="Logo of your website" style="max-width: 2.5rem;margin-left: 1rem;"></a>
          	...
          	<div class="row">
          		<div class="col-sm-12 col-md-6 topics">
          			...
          			<div class="row">
          				...
          				<div class="col-8">
          					<select id='sl' class="form-control" onchange="calc_score()" title="Select Skill Level">
          			...
          			<div class="row">
          				...
          				<div class="col-8" >
          					<select id='motive' class="form-control" onchange="calc_score()"title="select motive">
          			...
          			<div class="row">
          				...
          				<div class="col-8">
          					<select id='oppor' class="form-control" onchange="calc_score()" title="select opportunity">
          			...
          			<div class="row">
          				...
          				<div class="col-8">
          					<select id='size' class="form-control" onchange="calc_score()" title="select size">
